...
// Raylib 4.0 DrawTextRec() and moved its implementation into a couple of examples.
// This code comes from the https://github.com/raysan5/raylib/blob/master/examples/text/text_rectangle_bounds.c example.
